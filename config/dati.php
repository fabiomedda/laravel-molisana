...
return[
    'pasta' => [
        ...
        [
            ...
            "cottura" => "13 min",
            "peso" => "500g",
            "descrizione" => "Forse di origine romana le fettuccine hanno sicuramente natali centro-meridionali, ma la versione più famosa in tutto il mondo è quella delle Fettuccine alla Alfredo. Un primo piatto veloce e facile da realizzare con burro e parmigiano che delizia il palato grazie alla succulenta emulsione di formaggio che avvolge la pasta con una crema liscia e vellutata.  Molto amate anche le fettuccine ai funghi o alla boscaiola, oppure nella versione più semplice al limone o al tartufo. Le nostre fettuccine sono disponibili sia nella versione di semola che all’uovo e sono entrambe perfette per salse dense che assorbono il sugo.  Noi le prepariamo con vongole, branzino e un misto di verdure aromatizzate allo zenzero, oppure sempre a base di pesce con cozze, calamari e gamberetti."
        ],
        [
            ...
            "cottura" => "12 min",
            "peso" => "500g",
            "descrizione" => "Nel nostro Molino, situato a 500 m di distanza dal Pastificio di Campobasso, inizia il processo di trasformazione del grano duro, selezionato con cura maniacale ed una competenza tramandata da 4 generazioni. Il chicco, prima di essere macinato, viene decorticato a pietra e purificato con cura, raggiungendo standard di sicurezza e salubrità altissimi.  Il risultato delle numerose fasi di macinazione è una semola purissima, dal colore giallo ambrato, dalla consistenza piacevolmente granulosa, perfetta per essere impastata con le acque dalle caratteristiche oligominerali originate nel cuore del Massiccio del Matese. Il Molise, infatti, è per le sue caratteristiche fisiche una terra ideale per la produzione di pasta, come testimonia il proliferare di opifici e molini già agli inizi del secolo scorso.Un’ importante tradizione di maccaronai che La Molisana ha raccolto e perpetuato nel segno della Qualità.  Questa è la materia prima che caratterizza la nostra pasta, un prodotto ricco di alte proteine, che tiene perfettamente la cottura, dalla superficie dolcemente rugosa che attira e trattiene sapientemente i condimenti ed è adatta ad ogni tipo di preparazione.Come le nostre Linguine 6.  Note anche con il nome di bavette o trenette, le linguine appartengono alla stessa famiglia degli spaghetti, da cui si differenziano per la sezione che, anziché essere cilindrica, è piatta.In pratica è uno spaghetto schiacciato a sezione rettangolare con uno spessore medio.Rispetto alle linguine, le trenette hanno una sezione quadrata, uno spessore maggiore ed una minore larghezza.Il formato sembra avere origini liguri, in particolare genovesi ed è notoriamente abbinato al pesto o ai sughi di pesce.  Nell\'immaginario collettivo sono associate ad un abbinamento di pesce: linguine all\'astice oppure allo scoglio o ancora ai frutti di mare, agli scampi e vongole o anche semplicemente al limone.Da provare la ricetta delle linguine al nero di seppia.  Le nostre Linguine 6 al bronzo sono piacevolmente corpose, leggermente più spesse di quella classiche e perfette se abbinate a prosciutto croccante e perle di melone."
        ],
        [
            ...
            "cottura" => "11 min",
            "peso" => "500g",
            "descrizione" => "Non ci stancheremo mai di dire che se c’è qualcosa che ci rende diversi dagli altri è la possibilità di offrire un prodotto di cui controlliamo l’intero processo di produzione. Questa cura, che parte dal chicco di grano ed arriva fino alla tavola, rappresenta per il consumatore una certezza: tracciabilità e trasparenza. Questo asset che appartiene solo al 10% delle aziende del settore agroalimentare, è una garanzia di Qualità costante e controllata sia di prodotto che di processo.  Appartengono al nostro assortimento di paste classiche, le Mezze linguine 7 della stessa famiglia delle linguine, da cui differiscono per la larghezza leggermente inferiore.Una caratteristica che offre il vantaggio della maggiore facilità di“ arrotolamento” intorno forchetta tipico della pasta a sezione piatta.  Sono versatili e particolarmente amate con le preparazioni a base di pesce come ad esempio con gamberi e radicchio o tonno e pomodori.  Le nostre Mezze linguine 7 sono trafilate al bronzo e hanno una texture ruvida che cattura il condimento.A noi piacciono abbinate alla colatura di alici e ad un buon bicchiere di vino bianco!"
        ],
        [
            ...
            "cottura" => "9 min",
            "peso" => "500g",
            "descrizione" => "Figlio di cotanto padre, lo Spaghettino Quadrato 11, è venuto al mondo per accontentare quei pochi che non si erano innamorati dello Spaghetto Quadrato per via dello spessore esagerato. Con i suoi 1.75 centimetri di spessore lo spaghettino va benissimo per quelli che… less is more! È superversatile e si presta perfettamente a tutte le possibili ricette: leggere e vegetariane, condimenti cremosi e ricchi di ingredienti.Se spezzato, lo Spaghettino Quadrato 11, può accompagnare brodetti di pesce e arrotolato può accogliere come un nido i condimenti più svariati… Insomma, lo Spaghettino Quadrato 11 de La Molisana è destinato a grandi cose. Il nostro chef lo propone in una ricetta delicatissima, ma succulenta, con tocchetti di filetto di cernia profumato al basilico e straccetti di burrata pugliese.Il tutto completato da preziose gocce di caviale di peperoncino."
        ],
        [
        ...
        [
            ...
            "cottura" => "8 min",
            "peso" => "500g",
            "descrizione" => "La semola che viene utilizzata per produrre pasta La Molisana presenta le migliori caratteristiche qualitative che si identificano in un colore giallo paglierino, che riflette il colore dei campi, nella purezza e nell’alto valore nutritivo.La semola, alla stregua del grano, si compone di Carboidrati e Proteine.I primi sono rappresentati dall’ amido, le seconde prevalentemente dal Glutine e per la parte restante da proteine minori, ma ugualmente importanti.Le proteine della pasta La Molisana si caratterizzano per: <ol>
                <li>elevato contenuto, mai inferiore al 14 % a fronte del minimo di legge del 10, 5 %</li>
                <li>elevata tenacità</li>
                </ol> Due aspetti essenziali che definiscono la pasta di qualità e rendono La Molisana una pasta speciale, come i nostri Sedani Rigati 44. In passato erano noti come zanne di elefante, per via della leggera curvatura, poi hanno preso il nome di sedani rigati per via della rigatura che ricorda appunto quell’ ortaggio!Molto simili ai maccheroni, però più delicati nella forma, i Sedani Rigati 44 sono presenti sia nella gamma retail che in quella della ristorazione.Agli chef e ai professionisti della cucina particolarmente esigenti che lavorano con tempi molto stretti e richiedono alla pasta affidabilità nei processi di trasformazione, i nostri Sedani Rigati 44garantiscono ottime prestazioni sia in cottura espressa che in doppia cottura, inoltre una texture sempre al dente, grazie ad un indice proteico del 14, 5%, ed una superficie deliziosamente ruvida che cattura il condimento grazie alla trafilatura al bronzo."
        ],
        [
        ...
        [
            ...
            "cottura" => "12 min",
            "peso" => "500g",
            "descrizione" => "Altro elemento cult della famiglia de lo Spaghetto Quadrato (N.1 Spaghetto Quadrato. Una new entry che sarà molto apprezzata sia dai consumatori che dagli chef, perché il Ditale Quadrato è un formato deliziosamente piccolo ma sostanzioso.A dispetto del nome che fa pensare ad una pastina è un formato di pasta assolutamente versatile, adatto a moltissime ricette di primi piatti.La sua consistenza soda si sprigiona in bocca con un\'esplosione di emozioni, grazie agli spessori corposi, al colore elegantemente ambrato, alla texture delicatamente ruvida, cangiante e piacevolissima al tatto che trattiene il condimento sulla superficie.Il Ditale Quadrato sembra ideale per preparazioni strutturate come la ricetta con crema di broccoletto siciliano, calamari e pomodori semi secchi profumata al limone e carbone d\'olive nere."
        ]
    ]
        ];
